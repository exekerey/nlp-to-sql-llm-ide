...
import {AlertCircle, CheckCircle, Database, Globe, Key, Loader, Server, Shield} from 'lucide-react';
                ...
                <div className="bg-gray-800 rounded-lg p-8 max-w-md w-full mx-4 text-center">
                    ...
                    <div className="mt-6">
                        <div className="bg-gray-700 rounded-full h-2">
                            <div className="bg-blue-500 h-2 rounded-full transition-all duration-1000 animate-pulse"
                                 style={{width: '60%'}}></div>
                        </div>
    ...
    return (
        <div className="min-h-screen bg-gray-900 flex items-center justify-center p-4">
            <div className="bg-gray-800 rounded-lg shadow-2xl p-8 max-w-2xl w-full">
                ...
                {connectError && (
                    <div
                        className="p-3 mb-6 rounded-lg bg-red-900/30 border border-red-700 text-red-300 text-sm whitespace-pre-wrap break-words">
                        {connectError}
                    </div>
                )}
                ...
                <div className="mt-6 p-4 bg-gray-700 rounded-lg">
                    <p className="text-xs text-gray-400 mb-2">
                        <strong>Note:</strong> Make sure to follow PoLP. LLM can make mistakes.
                    </p>
                    <p className="text-xs text-gray-500">
                        from team qwerty12345 to shai.pro
                    </p>
                </div>
            </div>
        </div>
